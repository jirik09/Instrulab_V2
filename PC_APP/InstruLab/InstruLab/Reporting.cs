...
namespace LEO
{
    class Reporting
    {
        ...
        public void Sendreport(string capt, Exception ex, Device dev)
        {
        ...
        public void sendFeedback(string mail, string addres)
        {
            ...
            {
                MessageBox.Show("Unhandled exception. feedback cannot be send.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
