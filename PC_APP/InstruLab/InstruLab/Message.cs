...
namespace LEO
{
    public class Message
    {
        public enum MsgRequest { FIND_DEVICES, CONNECT_DEVICE, DISCONNECT, SCOPE_NEW_DATA, SCOPE_TRIGGERED,
            ...
            COUNTER_IC1_BUFF_WAIT, COUNTER_IC2_BUFF_WAIT, COUNTER_REF_WAIT, COUNTER_REF_WARN,
            COUNTER_TI_TIMEOUT, COUNTER_TI_DATA, COUNTER_IC_DUTY_CYCLE,
            COUNTER_IC_PULSE_WIDTH, NULL_MESSAGE
        }
